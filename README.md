...
<head>
  ...
  <title>Awareness on Health and Hygiene</title>
  <style>
    /* General CSS styles */
    body {
    ...
    header {
      background-color: rgb(130, 145, 221);
      color: #ffffff;
      padding: 20px;
      text-align: center;
    }
...
<body>
  ...
  <main>
    ...
    <section id="articles">
      ...
      <h2 style="background-color: yellow; text-align: center;">Health and Hygiene Abstract</h2>
